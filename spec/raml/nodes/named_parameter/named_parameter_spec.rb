describe Raml::Nodes::NamedParameter do
  ...
  it "is valid" do
    expect(Raml::Nodes::NamedParameter.new(valid_attributes).valid?).to eq(true)
  end

  it "sets defaults" do
    namedParameter = Raml::Nodes::NamedParameter.new({:name => "name"})
  ...
  it "is not valid when type is unknown" do
    ...
    namedParameter = Raml::Nodes::NamedParameter.new(attrs)
